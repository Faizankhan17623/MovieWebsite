...
const AboutUs = () => {
  return (
    <div className='w-full flex flex-row justify-around items-center h-breakpoint-sm '>
        ...
        <img src={'https://res.cloudinary.com/dp6kj5f6i/image/upload/v1750395456/20250618_1649_Monkey_with_Golden_Accessories_simple_compose_01jy1c43f4e288v1t0r8847gwq_qxyrwn.png'} alt="This is the know More" className='h-[300px] w-[20%] rounded-md' loading='lazy'/>
    </div>
  )
}
