...
const AboutUs = () => {
  return (
    <div className='w-full h-[900px] text-white  overflow-hidden '>
        <Navbar/>
        <div className='w-full h-[61%]  flex flex-col justify-center items-center gap-4 bg-richblack-600'>
            ...
            <div className='flex relative top-[50px] justify-around items-center bg-none w-full h-[100px] '>
                <img src={Image1} alt="First Logo" loading='lazy' className='w-[400px]'/>
                <img src={Image1} alt="Second Logo"  loading='lazy'className='w-[400px]'/>
                <img src={Image1} alt="Third Logo" loading='lazy'  className='w-[400px]'/>
            </div>
        </div>
...
<div className="w-full Aboutus flex justify-around items-center h-[800px] border relative ">
  <div className="w-[90%]">
    <div className="">
    ...
    <img src={Image1} alt="Logo"  loading="lazy"/>
  </div>
</div>
<div></div>
    </div>
